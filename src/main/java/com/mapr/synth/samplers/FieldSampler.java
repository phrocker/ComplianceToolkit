...
public abstract class FieldSampler implements Sampler<JsonNode> {
    ...
    public List<String> getVisibilityLabels(){
        return new ArrayList<>(visibilityLabels);
    }

    public void setVisibilityLabels(List<String> labels){
        visibilityLabels = new ArrayList<>(labels);
    }
